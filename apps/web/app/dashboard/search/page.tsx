      ...
      <div className={`flex-1 transition-all duration-300 ${sidebarOpen ? 'lg:ml-64' : 'lg:ml-0'}`}>
        ...
        <main className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
          ...
          <div className="mb-6">
            ...
            {/* Search Bar */}
            <div className="bg-white/90 backdrop-blur-sm shadow-lg rounded-xl p-4 border-2 border-fridge-cold/30">
                ...
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 border-2 border-fridge-cold rounded-xl focus:outline-none focus:ring-2 focus:ring-fridge-primary focus:border-fridge-primary transition-all text-fridge-dark placeholder:text-gray-400"
                      value={searchQuery}
          ...
          {isLoading ? (
            <div className="text-center py-20">
              ...
              <p className="text-fridge-dark text-lg">{t('search.searching')}</p>
            </div>
          ) : products.length === 0 ? (
            <div className="text-center py-20">
              <div className="mb-6">
                <span className="text-8xl block mb-4">🔍</span>
                <h2 className="text-2xl font-bold text-fridge-dark mb-2">
                  {searchQuery ? t('search.noResults') : t('search.startSearching')}
                </h2>
                <p className="text-fridge-dark/70 mb-6">
                  {searchQuery
            ...
            <>
              <div className="mb-4">
                <p className="text-fridge-dark/70">
                    ...
                    <div
                      ...
                      className={`bg-white rounded-xl shadow-lg p-6 border-2 transition-all hover:shadow-xl ${
                        isExpired
                          ...
                          : 'border-fridge-cold/30'
                      }`}
                    >
                      <div className="flex justify-between items-start mb-3">
                        <h3 className="text-lg font-bold text-fridge-dark flex-1">
                          {product.name}
                        </h3>
                        <button
                      ...
                      {product.category && (
                        <div className="mb-2">
                          <span className="inline-flex items-center px-2 py-1 bg-fridge-light text-fridge-dark rounded-lg text-xs font-medium">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {product.quantity > 1 && (
                          <div className="flex items-center space-x-2">
                            <span className="text-gray-500">📦</span>
                            <span className="text-fridge-dark">{t('products.quantity')}: {product.quantity}</span>
                          </div>
                        )}
                        ...
                        {product.location && (
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-fridge-dark capitalize">{product.location}</span>
                          </div>
                        )}
                      </div>
                    </div>
